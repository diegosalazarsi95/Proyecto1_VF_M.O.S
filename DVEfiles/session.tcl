...
# DVE full session
# Saved on Tue Nov 20 14:32:55 2018
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{89 89} {1362 774}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 345} {height 473} {dock_state left} {dock_on_new_line true} {child_hier_colhier 329} {child_hier_coltype 42} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 481} {height 473} {dock_state left} {dock_on_new_line true} {child_data_colvariable 252} {child_data_colvalue 89} {child_data_coltype 137} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
catch {gui_list_select -id ${Hier.1} {tbench_top.u_sdram32}}
...
gui_list_show_data -id ${Data.1} {tbench_top.u_sdram32}
...
gui_open_source -id ${Source.1}  -replace -active tbench_top /mnt/vol_NFS_Zener/WD_ESPEC/diegosalazar/Proyecto1_VF_M.O.S/./test_environment/testbench.sv
