...
# DVE full session
# Saved on Sat Nov 3 11:02:34 2018
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{89 52} {1363 738}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 346} {height 474} {dock_state left} {dock_on_new_line true} {child_hier_colhier 329} {child_hier_coltype 42} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 475
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 482} {height 474} {dock_state left} {dock_on_new_line true} {child_data_colvariable 252} {child_data_colvalue 89} {child_data_coltype 137} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_open_source -id ${Source.1}  -replace -active tbench_top /mnt/vol_NFS_Zener/WD_ESPEC/diegosalazar/Proyecto2_VF_M.O.S/./test_environment/testbench.sv
